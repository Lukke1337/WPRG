...
session_start();
if (isset($_POST['add_comment']) && !empty('content')) {
    ...
    $query = "INSERT INTO comments (post_id, comment, user_id, created_date) VALUES (?,?,?,?)";
    $stmt = $db->prepare($query);
    $stmt->bind_param('isis', $post_id, $comment, $user_id, $date);
    $stmt->execute();
